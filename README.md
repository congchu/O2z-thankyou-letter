...
이 프로젝트는 [Next.js](https://nextjs.org)와 [Tailwind CSS](https://tailwindcss.com)로 만들어진 프로젝트입니다.
...
[Next.js 배포 문서](https://nextjs.org/docs/app/building-your-application/deploying)를 확인하세요.
